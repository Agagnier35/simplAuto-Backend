...
input AdWhereInput {
  ...
  urgentExpiry: String
  urgentExpiry_not: String
  urgentExpiry_in: [String!]
  urgentExpiry_not_in: [String!]
  urgentExpiry_lt: String
  urgentExpiry_lte: String
  urgentExpiry_gt: String
  urgentExpiry_gte: String
  urgentExpiry_contains: String
  urgentExpiry_not_contains: String
  urgentExpiry_starts_with: String
  urgentExpiry_not_starts_with: String
  urgentExpiry_ends_with: String
  urgentExpiry_not_ends_with: String
  topExpiry: String
  topExpiry_not: String
  topExpiry_in: [String!]
  topExpiry_not_in: [String!]
  topExpiry_lt: String
  topExpiry_lte: String
  topExpiry_gt: String
  topExpiry_gte: String
  topExpiry_contains: String
  topExpiry_not_contains: String
  topExpiry_starts_with: String
  topExpiry_not_starts_with: String
  topExpiry_ends_with: String
  topExpiry_not_ends_with: String
  AND: [AdWhereInput!]
  OR: [AdWhereInput!]
  NOT: [AdWhereInput!]
}
...
input UserWhereInput {
  ...
  language_in: [ClientLanguage!]
  language_not_in: [ClientLanguage!]
